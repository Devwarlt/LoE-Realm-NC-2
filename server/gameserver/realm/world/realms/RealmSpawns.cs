...
namespace LoESoft.GameServer.realm
{
    internal partial class Realm
    {
        ...
        {
            new Spawn(WmapTerrain.ShoreSand, 1500,
            ...
            new Spawn(WmapTerrain.ShorePlains, 750,
                new List<KeyValuePair<string, double>>
                {
            ...
            new Spawn(WmapTerrain.LowPlains, 1500,
                new List<KeyValuePair<string, double>>
                {
                    Add("Hobbit Mage", 0.5),
            ...
            new Spawn(WmapTerrain.LowForest, 2500,
                new List<KeyValuePair<string, double>>
                {
                    Add("Elf Wizard", 0.2),
                    Add("Goblin Mage", 0.2),
            ...
            new Spawn(WmapTerrain.LowSand, 3750,
                new List<KeyValuePair<string, double>>
                {
            ...
            new Spawn(WmapTerrain.MidPlains, 3750,
                new List<KeyValuePair<string, double>>
                {
                    Add("Fire Sprite", 0.1),
                    Add("Ice Sprite", 0.1),
            ...
            new Spawn(WmapTerrain.MidForest, 2500,
                new List<KeyValuePair<string, double>>
                {
                    Add("Dwarf King", 0.3),
            ...
            new Spawn(WmapTerrain.MidSand, 500,
                new List<KeyValuePair<string, double>>
                {
            ...
            new Spawn(WmapTerrain.HighPlains, 1750,
                new List<KeyValuePair<string, double>>
                {
            ...
            new Spawn(WmapTerrain.HighForest, 2500,
                new List<KeyValuePair<string, double>>
                {
                    Add("Ogre King", 0.4),
                    Add("Dragon Egg", 0.1),
            ...
            new Spawn(WmapTerrain.Mountains, 75,
                new List<KeyValuePair<string, double>>
                {
                    Add("White Demon", 0.1),
                    Add("Sprite God", 0.09),
