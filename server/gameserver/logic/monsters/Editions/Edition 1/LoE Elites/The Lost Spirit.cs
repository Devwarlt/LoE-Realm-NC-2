...
namespace LoESoft.GameServer.logic
{
	partial class BehaviorDb
	{
		private _ LostSpirit = () => Behav()
			.Init("The Lost Spirit",
				new State(
					...
					new State("Awakening",
						...
						new Taunt("Who was awoken me from my slumber..?"),
				  ...
				  new State("backandforth",
					 ...
					 new State("1",
						...
						new ReturnToSpawn(once: false, speed: 4),
				  ...
				  new State("shadesandrek",
					...
					new State("returntospawn",
						new ReturnToSpawn(once: true, speed: 5),
		  ...
		  new AddCond(ConditionEffectIndex.Invulnerable, 5000),
		  ...
		  new State("loot"
				 ...
				 new Threshold(0.025,
					...
					//LT
					new ItemLoot("Crossbow of the Frozen North", 0.05),
					new ItemLoot("Phantom Light-X", 0.05),
					//SRT
					new ItemLoot("Galatic Axe", 0.001)
					 ),
				 new MostDamagers(10,
