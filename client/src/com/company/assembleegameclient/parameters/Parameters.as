...
public class Parameters {
    ...
    public static const ENVIRONMENT_DNS:String = !IS_DEVELOPER_MODE ? "us.tkgames.gg" : "localhost";
    ...
    public static const PORT:int = 5556;
    public static const POLICY:int = 5557;
